...
function MainRoutes() {
    ...
    const renderView = () => {
        switch (underlyingView) {
            ...
            case 'PROJECT_DETAIL':
                return <ProjectDetail projectId={selectedProjectId} navigateTo={navigateTo} initialPhotoId={editingPhotoId} initialFolderId={activeFolderId} returnView={projectDetailReturnView} />;
            case 'RECENT_PHOTOS':
